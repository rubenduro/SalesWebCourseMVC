...
using SalesWebCourseMVC.Models.Enums;

namespace SalesWebCourseMVC.Data
{
    public class SeedingService// this service is used to populate BD
    {
        private SalesWebCourseMVCContext _context;

        public SeedingService(SalesWebCourseMVCContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            _context.SaveChanges();//save all modifications 
        }
    }
}
